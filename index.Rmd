...
curriculum.df <- tibble(
  ...
  start = c(hm("9:00"), hm("9:30"), hm("11:00"), hm("12:00"), hm("13:00"), 
          ...
          hm("16:30"), hm("17:30")),
  label = c(NA, "html, request-response", NA, NA, "rvest, purrr", "RSelenium, APIs", NA),
...
ggplot(curriculum.df, aes(x = fct_rev(task), xend = fct_rev(task), 
  ...
  geom_label(aes(x = fct_rev(task), 
                 ...
                 label = label), size = 10, show.legend = FALSE) +
  coord_flip() +
  labs(x = "", y = "") +
...
.left[.footnote[<font size="3">(Bruns 2019, Puschmann 2019)</font size>]]
